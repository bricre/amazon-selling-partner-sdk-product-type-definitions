# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Product Type Definitions
...
```shell
composer require bricre/amazon-selling-partner-sdk-product-type-definitions
```
...
```php
<?php
use Amz\ProductTypeDefinitions\ResponseTypes;
